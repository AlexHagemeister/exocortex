...
| Program version | UNSET — the installed program release (tag or commit, with date). Stamped at install and by each `update-exocortex` run; the update check compares this against the latest release. |
